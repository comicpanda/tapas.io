...
/*! tapas.io 2016-09-01 */
!function(){var a,b=new MobileDetect(window.navigator.userAgent),c=b.ua,d=$(".text-me-callback-msg");/like Mac OS X/.test(c)?$(".app-store-btn.google").addClass("hidden"):/Android/.test(c)?$(".app-store-btn.apple").addClass("hidden"):$(".text-me-wrap").removeClass("hidden"),$("#text-me").on("input",function(b){var c=$(this);a=c.val().replace(/[^\d]/g,"").substring(0,10);var d=/^(?:\(\d{3}\)|\d{3})[- ]?\d{3}[- ]?\d{4}$/.test(a);/^(\d{3})?(\d{1,4})?$/.test(a)?c.val(a.replace(/^(\d{3})(\d{1,4})$/,"$1-$2")):c.val(a.replace(/^(\d{3})(\d{3})(\d{1,4})?$/,"($1) $2-$3")),c.next().toggleClass("active",d)}),$("a.text-me").on("click",function(b){q(b);var c=function(b,c,e){var f="Text has been sent!",g=!1;e.status||(f="Please check your number and try again (US only).",g=!0),d.text(f).removeClass("hidden").toggleClass("error",g).data("prevNumber",g?"":a),setTimeout(function(){d.addClass("hidden")},3e3)};d.data("prevNumber")!==a&&$(this).hasClass("active")&&$.post("/send-sms",{to:a}).done(c).fail(c)}),$(".js-line").each(function(){var a=$(this),b=a.find(".question");b.on("click tap",function(b){q(b),a.toggleClass("active",!a.hasClass("active"))})}),$(".js-nav-line").find("li").each(function(){var a=$(this),b=a.find("a");b.on("click tap",function(b){q(b),$(".js-nav-line").find("li").removeClass("active"),a.addClass("active"),r(b,$(this))})}),$(".js-nav-selected").on("click tap",function(a){q(a);var b=$(this);b.toggleClass("open",!b.hasClass("open"))}),$(".js-nav-item").find("li").each(function(){var a=$(this),b=a.find("a");b.on("click tap",function(a){q(a),r(a,$(this)),$(".js-nav-selected").removeClass("open")})});var e,f=$(".dot-wrap").find("li"),g=$(".info-card"),h=$(".screen-shot").find(".screen-img"),i=f.length,j=0,k=function(){e=setTimeout(function(){var a=j+1;l(f.eq(a===i?0:a))},5e3)};k();var l=function(a){clearTimeout(e);var b=$(a);f.removeClass("active"),b.addClass("active"),g.addClass("hide"),$(b.data("card")).removeClass("hide");var c=h.filter(".active"),d=$(b.data("shot"));c.removeClass("active").addClass("hide"),d.removeClass("hide").addClass("active"),j++,j===i&&(j=0),k()};$(".js-dot").on("click tap",function(){l(this)}),$(".js-info").on("swipeleft",function(){var a=$(".js-dot.active");a.next().length>0&&a.next().click()}),$(".js-info").on("swiperight",function(){var a=$(".js-dot.active");a.prev().length>0&&a.prev().click()}),$(".js-story").each(function(){var a=$(this),b=a.find("a").attr("href"),c=a.find("p");c.on("click tap",function(){window.open(b,"_blank")})});var m=$(".js-page-dot").length,n=$(".js-page-item.first"),o=$(".js-page-item.last"),p=function(a){var b=$(".js-news-item-"+a);$(".js-news").addClass("hidden").filter(b).removeClass("hidden")};$(".js-page-dot").on("click tap",function(a){q(a);var b=$(this),c=b.data("idx");$(".js-page-dot").removeClass("active").filter("[data-idx="+c+"]").addClass("active"),0===c?(n.removeClass("active"),o.addClass("active")):c===m-1?(n.addClass("active"),o.removeClass("active")):(n.addClass("active"),o.addClass("active")),p(c)}),$(".js-page-item").on("click tap",function(a){q(a);var b=$(this),c=$(".js-page-dot.active"),d=c.data("idx"),e=b.hasClass("first");if(e){if(0===d)return;var f=c.prev(),g=f.data("idx");b.toggleClass("active",0!==g),o.addClass("active"),f.click()}else{if(d===m-1)return;var h=c.next(),i=h.data("idx");b.toggleClass("active",i!==m-1),n.addClass("active"),h.click()}});var q=function(a){a&&(a.stopPropagation&&a.stopPropagation(),a.preventDefault&&a.preventDefault())},r=function(a,b){q(a);var c=b,d=$(c.data("id")),e=d.offset().top,f=Math.ceil(Math.abs($(window).scrollTop()-e)),g=Math.min(f?Math.max(.45*f,450):0,2e3);$("html , body").animate({scrollTop:e},{duration:g,easing:"easeInOutQuad"})};$(".js-team-img").on("mouseenter mouseleave",function(){var a=$(this),b=a.find("i"),c=b.data("alter"),d=b.attr("class"),e=a.next().find("p:last-child"),f=e.data("special"),g=e.text();b.removeClass().addClass(c).data("alter",d),e.text(f).data("special",g).toggleClass("open",!e.hasClass("open"))})}();