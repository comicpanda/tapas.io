...
/*! tapas.io 2016-03-14 */
!function(){var a=new MobileDetect(window.navigator.userAgent),b=a.ua;/like Mac OS X/.test(b)?$(".app-store-btn.google").addClass("hidden"):/Android/.test(b)?$(".app-store-btn.apple").addClass("hidden"):$(".app-store-msg").removeClass("hidden"),$(".js-line").each(function(){var a=$(this),b=a.find(".question");b.on("click tap",function(b){k(b),a.toggleClass("active",!a.hasClass("active"))})}),$(".js-nav-line").find("li").each(function(){var a=$(this),b=a.find("a");b.on("click tap",function(b){k(b),$(".js-nav-line").find("li").removeClass("active"),a.addClass("active"),l(b,$(this))})}),$(".js-nav-selected").on("click tap",function(a){k(a);var b=$(this);b.toggleClass("open",!b.hasClass("open"))}),$(".js-nav-item").find("li").each(function(){var a=$(this),b=a.find("a");b.on("click tap",function(a){k(a),l(a,$(this)),$(".js-nav-selected").removeClass("open")})});var c,d=$(".dot-wrap").find("li"),e=$(".info-card"),f=$(".screen-shot").find(".screen-img"),g=d.length,h=0,i=function(){c=setTimeout(function(){var a=h+1;j(d.eq(a===g?0:a))},3e3)};i();var j=function(a){clearTimeout(c);var b=$(a);d.removeClass("active"),b.addClass("active"),e.addClass("hide"),$(b.data("card")).removeClass("hide");var j=f.filter(".active"),k=$(b.data("shot"));j.removeClass("active").addClass("hide"),k.removeClass("hide").addClass("active"),h++,h===g&&(h=0),i()};$(".js-dot").on("click tap",function(){j(this)}),$(".js-info").on("swipeleft",function(){var a=$(".js-dot.active");a.next().length>0&&a.next().click()}),$(".js-info").on("swiperight",function(){var a=$(".js-dot.active");a.prev().length>0&&a.prev().click()});var k=function(a){a&&(a.stopPropagation&&a.stopPropagation(),a.preventDefault&&a.preventDefault())},l=function(a,b){k(a);var c=b,d=$(c.data("id")),e=d.offset().top,f=Math.ceil(Math.abs($(window).scrollTop()-e)),g=Math.min(f?Math.max(.45*f,450):0,2e3);$("html , body").animate({scrollTop:e},{duration:g,easing:"easeInOutQuad"})}}();