...
/*! tapas.io 2017-02-02 */
!function(){var a=new MobileDetect(window.navigator.userAgent),b=a.ua;$(".text-me-callback-msg");/like Mac OS X/.test(b)?$(".app-store-btn.google").addClass("hidden"):/Android/.test(b)?$(".app-store-btn.apple").addClass("hidden"):$(".text-me-wrap").removeClass("hidden"),$(".js-line").each(function(){var a=$(this),b=a.find(".question");b.on("click tap",function(b){o(b),a.toggleClass("active",!a.hasClass("active"))})}),$(".js-nav-line").find("li").each(function(){var a=$(this),b=a.find("a");b.on("click tap",function(b){o(b),$(".js-nav-line").find("li").removeClass("active"),a.addClass("active"),p(b,$(this))})}),$(".js-nav-selected").on("click tap",function(a){o(a);var b=$(this);b.toggleClass("open",!b.hasClass("open"))}),$(".js-nav-item").find("li").each(function(){var a=$(this),b=a.find("a");b.on("click tap",function(a){o(a),p(a,$(this)),$(".js-nav-selected").removeClass("open")})});var c,d=$(".dot-wrap").find("li"),e=$(".info-card"),f=$(".screen-shot").find(".screen-img"),g=d.length,h=0,i=function(){c=setTimeout(function(){var a=h+1;j(d.eq(a===g?0:a))},5e3)};i();var j=function(a){clearTimeout(c);var b=$(a);d.removeClass("active"),b.addClass("active"),e.addClass("hide"),$(b.data("card")).removeClass("hide");var j=f.filter(".active"),k=$(b.data("shot"));j.removeClass("active").addClass("hide"),k.removeClass("hide").addClass("active"),h++,h===g&&(h=0),i()};$(".js-dot").on("click tap",function(){j(this)}),$(".js-info").on("swipeleft",function(){var a=$(".js-dot.active");a.next().length>0&&a.next().click()}),$(".js-info").on("swiperight",function(){var a=$(".js-dot.active");a.prev().length>0&&a.prev().click()}),$(".js-story").each(function(){var a=$(this),b=a.find("a").attr("href"),c=a.find("p");c.on("click tap",function(){window.open(b,"_blank")})});var k=$(".js-page-dot").length,l=$(".js-page-item.first"),m=$(".js-page-item.last"),n=function(a){var b=$(".js-news-item-"+a);$(".js-news").addClass("hidden").filter(b).removeClass("hidden")};$(".js-page-dot").on("click tap",function(a){o(a);var b=$(this),c=b.data("idx");$(".js-page-dot").removeClass("active").filter("[data-idx="+c+"]").addClass("active"),0===c?(l.removeClass("active"),m.addClass("active")):c===k-1?(l.addClass("active"),m.removeClass("active")):(l.addClass("active"),m.addClass("active")),n(c)}),$(".js-page-item").on("click tap",function(a){o(a);var b=$(this),c=$(".js-page-dot.active"),d=c.data("idx"),e=b.hasClass("first");if(e){if(0===d)return;var f=c.prev(),g=f.data("idx");b.toggleClass("active",0!==g),m.addClass("active"),f.click()}else{if(d===k-1)return;var h=c.next(),i=h.data("idx");b.toggleClass("active",i!==k-1),l.addClass("active"),h.click()}});var o=function(a){a&&(a.stopPropagation&&a.stopPropagation(),a.preventDefault&&a.preventDefault())},p=function(a,b){o(a);var c=b,d=$(c.data("id")),e=d.offset().top,f=Math.ceil(Math.abs($(window).scrollTop()-e)),g=Math.min(f?Math.max(.45*f,450):0,2e3);$("html , body").animate({scrollTop:e},{duration:g,easing:"easeInOutQuad"})};$(".js-team-img").on("mouseenter mouseleave",function(){var a=$(this),b=a.find("i"),c=b.data("alter"),d=b.attr("class"),e=a.next().find("p:last-child"),f=e.data("special"),g=e.text();b.removeClass().addClass(c).data("alter",d),e.text(f).data("special",g).toggleClass("open",!e.hasClass("open"))})}();